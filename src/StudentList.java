...
public class StudentList {
    ...
    public StudentList(String listId,TimeTableSlot timeTableSlot,TimeTable timeTable ,DatabaseConnection db) {
        this.listId=listId;
        ResultSet rs;
        try {
            ...
            if(rs.next()){
                ...
                for(int i=startNum;i <= endNum;i++){
                    student.add(new Student(String.format("%s%03d",startRoll,i),timeTableSlot,timeTable,db));
                }
                setStudent(student);
            }
